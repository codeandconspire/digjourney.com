...
var { i18n, asText, resolve, loader, src, srcset, HTTPError, memo } = require('../components/base')
...
function productView (state, emit) {
  emit('theme', 'pink')
  return state.prismic.getByUID('product', state.params.slug, function (err, doc) {
