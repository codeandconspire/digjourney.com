          ...
          <div class="u-md-container">
            <div class="">
              ...
              <div class="u-container">
                ${caption
                  ? html`<figcaption class="Text-caption">
                      ${caption}
                    </figcaption>`
                  : null}
              </div>
          ...
          <section class="u-container u-space2">
            ...
            ${grid(
              ...
              blurbs.map(function (item, i) {
                var title = asText(item.heading);
                if (!title && item.link.id)
                  title = asText(item.link.data.title);

                var body = item.text.length
              ...
              return html`
                <div class="Text Text--small">
                  ${symbol && symbol in symbols
                    ...
                    ? html`<span class="Text-number">${symbol}</span>`
                    : null}
                  <div>
