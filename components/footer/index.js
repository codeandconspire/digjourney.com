                    ...
                    >
                      <label for="MERGE0">
                        <span class="u-hiddenVisually"
                          >${text`Fill in your e-mail address`}</span
                        >
                        <input
                          class="Footer-email"
                          type="email"
                      ...
                      ${self.local.message
                        ? html`<span class="Footer-message"
                            >${this.local.message}</span
                          >`
                        : null}
                    </form>
                  </div>
          ...
          <div class="u-container">
            ...
            <div class="Footer-meta ${alt ? 'u-slideDown' : ''}">
              ...
              <span class="Footer-copy"
                >${text`© ${new Date().getFullYear()} DigJourney`}</span
              >
            </div>
          </div>
        </div>
