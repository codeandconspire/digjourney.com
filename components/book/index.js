          ...
          <div class="Book-body">
            ...
            ${props.rating ? html`
              <span class="Book-rating" data-rating="${props.rating}">
                <span class="u-hiddenVisually">${text`Rating: ${props.rating.length} of 5`}</span>
              </span>
            ` : null}
            ${props.author ? html`
            ...
            <div class="Text">
              ${props.body}
              ${props.link ? html`<p><a href="${props.link.href}">${props.link.text}</a></p>` : null}
            </div>
          </div>
          ${props.action ? html`
